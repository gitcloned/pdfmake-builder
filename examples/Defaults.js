...
/** modify default formatting for date */
DEFAULTS.DataTableColumnFormatting[dataTable.DATA_COLUMN_TYPE.Date] = 'MM/DD/YYYY'
...
new PDFReport()
    ...
    .then(stream => {
        ...
        stream.pipe(require('fs').createWriteStream('Defaults.pdf'))
        stream.end()
    })